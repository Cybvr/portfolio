...
export function ToptalBadge({ className = '' }: { className?: string }) {
  return (
    <div className={`flex justify-center md:justify-start ${className}`}>
      ...
      >
        <div
          className="flex w-[200px] flex-col items-center gap-2 bg-[linear-gradient(153deg,#0667ff_18%,#204ecf_40%,#0f256e_80%)] px-5 pb-10 pt-6 text-center text-white shadow-[0_28px_50px_rgba(6,30,96,0.35)]"
          style={{ clipPath: hexagonClipPath }}
        >
          ...
          <h3 className="m-0 text-[19px] font-bold leading-none tracking-[0.08em]">TOP 3% TALENT</h3>
          <div className="h-px w-[120px] bg-[#25a9ef]" />
          <span className="mb-[-6px] text-base opacity-80">Vetted by</span>
          <svg viewBox="0 0 108 30" width="100" xmlns="http://www.w3.org/2000/svg" aria-label="Toptal">
          ...
          <a
            href="https://www.toptal.com/designers/resume/jide-pinheiro#Xpm6rb"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center rounded-md bg-[#296bff] px-5 py-1 text-base font-medium text-white underline decoration-[0.5px] underline-offset-2 transition-transform hover:-translate-y-0.5"
          >
            Hire me
          </a>
        </div>
